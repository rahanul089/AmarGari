"""
AmarGari - Mock data generator.
Generates realistic, relational Bangladesh-style demo data directly into
the Supabase (Postgres) database. No CSV files are written.
...
def generate():
    ...
    # --- Admin account ---
    admin = User(name="System Admin", email="admin@amargari.gov.bd",
    ...
    demo = User(name="Rafiq Islam (Demo)", email="demo@amargari.gov.bd",
    ...
    # --- Settings ---
    default_settings = {
        "site_name": "AmarGari - Smart Driver & Vehicle Owner Portal",
        "support_email": "support@amargari.gov.bd",
    ...
    print("\nDemo login -> email: demo@amargari.gov.bd | password: Demo@123")
    print("Admin login -> email: admin@amargari.gov.bd | password: Admin@123")
