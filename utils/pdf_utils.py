"""
AmarGari - PDF generation helpers (ReportLab)
"""
import io
...
def generate_receipt_pdf(title: str, fields: dict) -> bytes:
    ...
    elements = [
        Paragraph("AmarGari", header_style),
        Paragraph("Amar Gari — Smart Driver & Vehicle Owner Portal", styles["Normal"]),
        Spacer(1, 12),
    ...
    elements.append(Paragraph("This is a system-generated document from AmarGari. No signature required.",
                               styles["Italic"]))
